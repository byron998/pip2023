...
public class SchedulDto implements Serializable {
	...
	@Min(value = 1, message = "{schedul.hall.ismin.error}", groups = { Validgroup.insert.class, Validgroup.update.class,
			Default.class })
	@Max(value = 99, message = "{schedul.hall.ismax.error}", groups = { Validgroup.insert.class,
			Validgroup.update.class, Default.class })
	private int hall;
	@Min(value = 1, message = "{schedul.price.ismin.error}", groups = { Validgroup.insert.class,
			Validgroup.update.class, Default.class })
	@Max(value = 999, message = "{schedul.price.ismax.error}", groups = { Validgroup.insert.class,
			Validgroup.update.class, Default.class })
	private int price;
